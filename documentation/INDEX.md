# IronTrak Documentation

**Complete technical documentation for the IronTrak bandsaw fence position tracker**
...
1. **Keep GEMINI.md in sync** - Update `/GEMINI.md` if hardware stack changes
2. **Update version numbers** - Change "Last Updated" and firmware version at bottom of each file
3. **Cross-reference changes** - If changing one doc, check references in others
4. **Test examples** - Verify code snippets compile and work
5. **Screenshot updates** - Replace outdated images if UI changes

---

**Need help?** See individual documentation files or open a GitHub issue.
