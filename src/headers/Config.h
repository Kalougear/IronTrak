...
// Main Measuring Encoder (Industrial Optical)
// MUST be on Interrupt Pins (2 & 3 for Nano)
#define PIN_ENCODER_A       2
#define PIN_ENCODER_B       3

// Menu Encoder (KY-040)
#define PIN_MENU_CLK        4
#define PIN_MENU_DT         5
#define PIN_MENU_SW         6

// I2C LCD (A4=SDA, A5=SCL)
// Address is typically 0x27 or 0x3F
...
// Default Wheel Diameter in mm (Calibrate this!)
#define DEFAULT_WHEEL_DIA_MM    50.0f
#define PULSES_PER_REV          2400  // 600 PPR * 4 (Quadrature)

// ============================================================================
// EEPROM ADDRESS MAP
// ============================================================================
#define EEPROM_ADDR_MAGIC       0   // Magic byte to check if initialized
